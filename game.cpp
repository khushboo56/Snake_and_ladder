...
void gamescore(int p1,int p2,string player1name,string player2name)
{
	cout << "\n";
    draw_line(50, '~');
    cout << "\n\t\tGAME STATUS\n";
    ...
    cout << "\t--->" <<player2name<< " is at position " << p2 << endl;
    draw_line(50, '_');
	cout<<endl;	
}
...
int main()
{
	...
	cin>>player1name;
	cout<<"\n"<<"Enter Name of Player2:"<<endl;
	cin>>player2name;
	while(player1<=100 && player2<=100)
	{
		char tin;
		board;
		gamescore(player1,player2,player1name,player2name);
